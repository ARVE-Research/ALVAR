...
use orbitmod,      only : orbitpars,insolation,calcorbitpars,toa_insolation
use radiationmod,  only : initairmass,calcPjj,elev_corr,radpet
...
! real(dp) :: dayl_n, tday, tnight
! type(orbitpars) :: orbit
! real(dp) :: ww, dayl, delta
!
...
!
!
! ! call diurnaltemp(22.,26.,23.,tday,tnight)
! !
! ! print *, tday,tnight
!
! call calcorbitpars(1950, orbit)
!
! call toa_insolation(orbit, 1, 30., ww, dayl, delta)
!
! call calcPjj(temp_test, prec_test, Pjj)
!
! met_test%tmin = 29.
! met_test%tmax = 35.
! met_test%prec = 30.
...
!
!
! call radpet(orbit, 30., 14., Pjj, 1, 0.8, met_test)

! print *, met_test%tdew, met_test%dayl, dayl, Pjj, met_test%srad, ww, met_test%dpet
